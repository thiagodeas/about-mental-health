  ...
  <template>
    <div class="w-full">
      ...
      <div class="flex justify-center items-center min-h-screen w-full bg-white pl-16" data-aos="fade-left">
      ...
      <div class="flex justify-center flex-row-reverse items-center min-h-screen w-full bg-white pr-12" data-aos="fade-right">
      ...
      <div class="flex justify-start items-center min-h-screen flex-col w-full bg-white pt-8 gap-8" data-aos="fade-up">
        <div>
          <h1 class="font-amatic text-8xl font-bold text-lightRed tracking-wide pb-8">PRECONCEITO</h1>
        </div>

        <div class="flex justify-center items-center flex-col w-[800px] text-center bg-lightPurple p-10 rounded-2xl clip-path-softTilt"  data-aos="fade-up">
        ...
        <div class="flex justify-center items-center flex-col w-[700px] text-center gap-4 pr-12" data-aos="fade-up">
